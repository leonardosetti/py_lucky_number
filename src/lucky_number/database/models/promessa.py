...
class Promessa(Base, TimestampMixin):
    ...
    hash_compartilhamento: Mapped[str | None] = mapped_column(String(128), unique=True, nullable=True)
    compartilhado_em: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
