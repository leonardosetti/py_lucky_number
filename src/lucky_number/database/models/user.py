...
class User(Base, TimestampMixin):
    ...
    pais: Mapped[str | None] = mapped_column(
        String(50), nullable=True, default="Brasil"
    )
    ...
    telefone_verificado_em: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
    ...
    codigo_ativacao_enviado_em: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
    ...
    # Biometrics / push
    biometria_habilitada: Mapped[bool] = mapped_column(
